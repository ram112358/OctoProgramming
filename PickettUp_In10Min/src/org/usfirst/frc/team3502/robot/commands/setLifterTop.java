 ...
 *
 */
public class setLifterTop extends Command {
	
	private double setpoint = 8, time;
    ...
    protected boolean isFinished() {
    	...
    	if(Robot.lifter.getLiftTopStopper()){
    		return true;
    	}
    	else{
    		return false;
    ...
    private void writeFile() throws IOException{
		openFile();
    	BufferedWriter outputFile = new BufferedWriter(new FileWriter(path, true));
    	outputFile.write(timer.get()+"\ttop");
    	outputFile.newLine();
    	outputFile.close();
    }
}
