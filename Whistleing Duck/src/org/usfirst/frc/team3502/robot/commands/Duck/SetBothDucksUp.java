 ...
 *
 */
public class SetBothDucksUp extends Command {
	
	public double
		topPos,
		bottomPos;
	
    public SetBothDucksUp() {
    ...
    protected void initialize() {
    	...
    	topPos = NetworkTable.getTable("Preferences").getNumber("upTopPos", 0.0);
    	bottomPos = NetworkTable.getTable("Preferences").getNumber("upBottomPos", 0.0);
    }
